...
36. 删除账号包含其在他人共享会话发起的任务／通知，不因 admission 外键失败、不先删恢复证明、不停止其他参与者；只有普通 admission 的账号可删除，清理失败和重启可恢复。
