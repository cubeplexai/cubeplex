...
frontend share one app version, e.g. `v0.6.0` — and set it as `BACKEND_TAG` /
...
BACKEND_TAG=v0.6.0        # a release version from the releases page
FRONTEND_TAG=v0.6.0
...
#     image:   "ghcr.io/cubeplexai/cubeplex-sandbox:v0.6.0"
