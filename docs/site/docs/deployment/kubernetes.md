...
egress:
  ...
  webhook:
    image:
      tag: "v0.7.0"             # same release version as backend/frontend
...
image:
  ...
  backend:  { name: "cubeplex-backend",  tag: "" }     # tag required (e.g. v0.7.0)
  frontend: { name: "cubeplex-frontend", tag: "" }     # tag required (e.g. v0.7.0)
