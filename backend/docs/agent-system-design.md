...
4. The CubeLoop agent streams events while `RunManager` maps them to CubePlex events and writes them to the Redis run stream consumed by SSE clients.
