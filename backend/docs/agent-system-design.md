...
6. CubePlex performs usage aggregation and final metadata updates, then emits the sole public `DoneEvent`. CubeLoop's internal `ExecutionFinished` event is never projected to SSE.
