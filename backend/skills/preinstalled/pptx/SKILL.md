...
Cubebox adaptation of MiniMax `pptx-generator`.

## Cubebox Sandbox Path

Enabled skill files are available at `/.skills/pptx/1.0.0-cubebox.2/`.

```bash
export SKILL_DIR="/.skills/pptx/1.0.0-cubebox.2"
cd "$SKILL_DIR"
```
