...
Cubebox adaptation of MiniMax `minimax-docx`.

## Cubebox Sandbox Path

Enabled skill files are available at `/.skills/docx/1.0.0-cubebox.2/`.

```bash
export SKILL_DIR="/.skills/docx/1.0.0-cubebox.2"
cd "$SKILL_DIR"
```
