...
Cubebox adaptation of MiniMax `minimax-xlsx`.

## Cubebox Sandbox Path

Enabled skill files are available at `/.skills/xlsx/1.0.0-cubebox.2/`.

```bash
export SKILL_DIR="/.skills/xlsx/1.0.0-cubebox.2"
cd "$SKILL_DIR"
```
