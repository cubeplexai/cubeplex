...
Revision ID: 7bb73b55aa6a
Revises: 
Create Date: 2026-04-29 23:43:04.809702
...
def upgrade() -> None:
    ...
    sa.Column('creator_user_id', sqlmodel.sql.sqltypes.AutoString(length=36), nullable=False),
    ...
    sa.Column('id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('conversation_id', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('uploader_user_id', sqlmodel.sql.sqltypes.AutoString(length=36), nullable=False),
