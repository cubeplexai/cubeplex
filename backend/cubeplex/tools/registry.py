"""cubeloop-side tool registry (M2).

Exposes builtin tools as cubeloop.AgentTool. M2.2/M2.3 add memory + load_skill;
...
def list_builtin_tools() -> list[AgentTool]:  # type: ignore[type-arg]
    """Return cubeloop-shaped builtin tools that require no DI.
