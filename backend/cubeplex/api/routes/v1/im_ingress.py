...
Unauthenticated by cubeplex session — the verification is the platform's
...
from cubeplex.im.feishu.link_command import handle_link_command, parse_link_command
from cubeplex.im.feishu.reset_command import handle_reset_command, parse_reset_command
...
async def _try_decrypt_against_enabled_accounts(
    ...
    Iterates enabled feishu accounts (typically 1–2 per cubeplex deploy);
