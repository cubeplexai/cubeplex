...
from cubeplex.mcp.oauth import (
    DCRClient,
...
from cubeplex.services.mcp_templates import MCPConnectorTemplateService
...
def _state_secret_key() -> bytes:
    ...
    if not secret:
        raise RuntimeError("CUBEPLEX_AUTH__CSRF_SECRET missing")
