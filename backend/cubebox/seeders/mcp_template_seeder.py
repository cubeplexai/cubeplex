...
# Backwards-compatible alias for callers that haven't migrated yet (e.g.
# ``cubebox.api.app``). Removed in plan Task 9 alongside the legacy
# catalog model and routes.
