...
function TrustInfo({ trust }: { trust: SkillCandidateOut['trust'] }) {
  if (trust === 'official') {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-success-solid/10 px-2 py-1 text-xs font-medium text-success-fg">
  ...
  if (trust === 'community') {
    return (
      <span className="inline-flex items-center gap-1.5 rounded-full bg-info-solid/10 px-2 py-1 text-xs font-medium text-info-fg">
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full bg-warning-solid/10 px-2 py-1 text-xs font-medium text-warning-fg">
