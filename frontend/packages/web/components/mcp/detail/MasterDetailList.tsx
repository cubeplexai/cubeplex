...
export interface MasterDetailListProps<T extends { name?: string; description?: string }> {
  items: T[]
...
function defaultFilter<T extends { name?: string; description?: string }>(
  item: T,
  q: string,
): boolean {
...
export function MasterDetailList<T extends { name?: string; description?: string }>({
  items,
  getKey,
  filter,
  selectedKey,
