...
/**
 * Workspace topic picker for trigger creation.
 *
 * Triggers can pin every ingested event into a shared topic so the runs end up
 * in one logical group. The picker lists topics from `/api/v1/topics`,
 * supports a clear button (no topic = standalone conversation per event), and
 * surfaces an inline search filter once the workspace has many topics.
 *
 * Co-located with the trigger form per the "modules own their atoms" rule;
    ...
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center gap-2">
        <button
          ...
          data-testid="trigger-topic-picker-trigger"
        >
        ...
        {clearable && value !== null && (
          <button
            ...
            data-testid="trigger-topic-picker-clear"
          >
      ...
      {open && (
        <div
          ...
          role="listbox"
          data-testid="trigger-topic-picker-list"
        >
          {topics.length > 8 && (
            <input
              type="text"
