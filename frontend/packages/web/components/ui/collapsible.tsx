...
function Collapsible({
  ...
  const [internalOpen] = React.useState(defaultOpen ?? false)
  const isOpen = open !== undefined ? open : internalOpen

  return <div data-slot="collapsible" data-state={isOpen ? 'open' : 'closed'} {...props} />
}

function CollapsibleTrigger({ onClick, ...props }: React.ComponentProps<'button'>) {
  return <button data-slot="collapsible-trigger" type="button" onClick={onClick} {...props} />
}
