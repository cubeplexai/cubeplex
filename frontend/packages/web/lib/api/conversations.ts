 ...
 * `@cubebox/core` (``packages/core/src/api/stream.ts``). This file re-exports
 ...
 * be layered on without round-tripping through `@cubebox/core`.
 */

export type { SendMessageRequest } from '@cubebox/core'
