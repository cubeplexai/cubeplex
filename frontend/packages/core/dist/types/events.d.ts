...
export type PanelContentType = 'search' | 'code_execute' | 'web_fetch' | 'terminal' | 'write_file' | 'generic' | 'artifact' | 'skill' | 'file_read';
export type AgentEventType = 'text_delta' | 'reasoning' | 'tool_call' | 'tool_call_delta' | 'tool_result' | 'artifact' | 'error' | 'done' | 'citation' | 'status' | 'usage' | 'injected_message' | 'sandbox_confirm_request' | 'sandbox_confirm_resolved' | 'ask_user_request' | 'ask_user_resolved';
