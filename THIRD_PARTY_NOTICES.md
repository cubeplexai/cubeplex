...
website (https://www.dicebear.com/styles/).

  - "Glyphs" avatar style (default)
      Design by Matt Houser — CC BY 4.0
      (https://creativecommons.org/licenses/by/4.0/)
      Code: MIT (Florian Körner)

  - "Notionists" avatar style
      Design by Zoish (https://bio.link/heyzoish) — CC0 1.0
      (https://creativecommons.org/publicdomain/zero/1.0/)
      Source: https://heyzoish.gumroad.com/l/notionists
      Code: MIT (Florian Körner)

  - "Open Peeps" avatar style
      Design by Pablo Stanley (https://twitter.com/pablostanley) — CC0 1.0
      (https://creativecommons.org/publicdomain/zero/1.0/)
      Source: https://www.openpeeps.com/
      Code: MIT (Florian Körner)

  - "Micah" avatar style
      Design by Micah Lanier (https://dribbble.com/micahlanier) — CC BY 4.0
      (https://creativecommons.org/licenses/by/4.0/)
  ...
  - "Bottts" avatar style
      Design by Pablo Stanley (https://bottts.com/) —
